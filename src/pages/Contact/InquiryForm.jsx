...
const InquiryForm = () => {
  ...
  return (
    ...
    >      
      <Box mb={{xs: 3, sm: 4}}>
        <Typography variant="body1" lineHeight={1.25} fontWeight={500} fontSize={{xs: 17, sm:20}} mb={1}>
          I'm looking forward to hearing from you!
        </Typography>
        <Typography variant="body1" lineHeight={1.2} fontWeight={300} fontSize={{ xs: 14, sm: 16 }}>
      ...
      > 
        ...
        <Box sx={{display: "flex", justifyContent: "center", mb: { xs: 5, sm: 6,  }}}>
