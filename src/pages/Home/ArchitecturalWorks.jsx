    ...
    <Box sx={{position: "relative", height: "100%", backgroundColor: "background.paper"}}>
      <Container maxWidth="xl" sx={{pt: 0, height: "100%"}}>
        <Grid container sx={{height: "100%"}}>
          <Grid item xs={3.} sx={{zIndex: 2, backgroundColor: "primary.main", display: "flex", flexDirection: "column", justifyContent: "center", p: 2, mb: 10, pb: 10, boxShadow: 2}}>
            <Box align="left" sx={{}}>
              <Typography variant="h2" lineHeight={1.1} fontWeight={700} sx={{opacity: .95}} fontSize={{lg: 40}} color="background.default" ml={.25}>ARCHITECTURAL</Typography>
              <Typography variant="h3" fontWeight={200} lineHeight={1.1} sx={{opacity: .8}} fontSize={{lg: 38}} letterSpacing={1} color="background.paper">DESIGN</Typography>
            </Box>
          ...
          <Grid item xs={9} sx={{zIndex: 2, display: "flex", flexDirection: "column", height: "100%", overflow: "auto", width: "100%"}}>
